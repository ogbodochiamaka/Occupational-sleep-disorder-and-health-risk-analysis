...
![]<img width="800" height="400" alt="image" src="https://github.com/user-attachments/assets/dcf112d5-591b-4d41-bfe7-6d7473de3d0a" />
## Introduction:
...
## Methodology:
To evaluate Occupational Sleep Disorder & Health Risk project, the dataset was downloaded as excel file from kaggle.com and following excel features were incorporated:
- Power query
- Power pivot
- Pivot table
- Charts and Bar
...
- I imported raw datasets as excel from kaggle.com
- I cleaned and transformed data using Power Query (removing duplicates, correcting data types, handling null values).
- I used Power Pivot to calculate measures and create custom metrics such as Ave.sleep, Ave.age, Ave. sleep duration, Ave. sleep quality etc. 
